...
static inline u32 rvzbs_bexti(u8 rd, u8 rs, u8 shamt)
{
	return rv_i_insn(0x480 | shamt, rs, 5, rd, 0x13);
}

static inline u32 rvzbs_binvi(u8 rd, u8 rs, u8 shamt)
{
	return rv_i_insn(0x680 | shamt, rs, 1, rd, 0x13);
}
